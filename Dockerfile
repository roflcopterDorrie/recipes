...
COPY ./recipes-httpd.conf /etc/apache2/apache2.conf
COPY ./recipes-000-default.conf /etc/apache2/sites-available/000-default.conf
...
#RUN openssl req -new -x509 -days 999 -nodes -out /etc/ssl/certs/apache.pem -keyout /etc/ssl/certs/apache.pem -subj "/C=AU/ST=ACT/L=Canberra/O=DuckDNS/CN=rolfe.duckdns.org"
#RUN chown www-data:www-data /etc/ssl/certs/apache.pem

# Install Composer
RUN curl -sS https://getcomposer.org/installer | php -- --install-dir=/usr/local/bin --filename=composer

#RUN composer config --no-plugins allow-plugins.yiisoft/yii2-composer
...
#RUN chown www-data:www-data "/etc/ssl/certs/"
#RUN chown www-data:www-data "/etc/ssl/private/"

#RUN chown www-data:www-data "/etc/ssl/certs/ssl-cert-snakeoil.pem"
#RUN chown www-data:www-data "/etc/ssl/private/ssl-cert-snakeoil.key"

#RUN ls -la "/etc/ssl/certs/ssl-cert-snakeoil.pem"
#RUN ls -la "/etc/ssl/private/ssl-cert-snakeoil.key"
