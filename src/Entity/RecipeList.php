...
use Drupal\recipes\Form\RecipeListForm;
use Drupal\recipes\RecipeListInterface;
use Drupal\recipes\RecipeListListBuilder;
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    $fields['recipes'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setSetting('handler_settings', [
        'target_bundles' => ['recipe'], // your content type machine name
      ])
