...
/**
 * RecipePlannerIngredientController implements the CRUD actions for RecipePlannerIngredient model.
 */
class ShoppingListController extends Controller {
    ...
    public function actionIndex() {
        $shoppingList = RecipePlannerIngredient::find()->indexBy('id')->where(['collected' => 0])->all();
